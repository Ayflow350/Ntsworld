...
const Terms = () => {
  return (
    <div>
      ...
      <div className="container mx-auto px-7 py-6 md:px-12 leading-7z font-body">
        <div className="">
          <div className="">
            <h1 className="text-2xl font-bold md:text-3xl">
              AGREEMENT TO TERMS
            </h1>
            <p className=" mt-5 w-6/5 md:w-4/5">
              These Terms of Use constitute a legally binding agreement made
              between you, whether personally or on behalf of an entity (“you”)
              and Zyteon, ("Zytxeon", “we”, “us”, or “our”), concerning your
              access to and use of the Zyteon website as well as any other media
            ...
            <p className="w-6/5 mt-5 md:w-4/5 ">
              Unless otherwise indicated, the Site are our proprietary property
            ...
            <h1 className="text-3xl font-bold mt-5">USER REPRESENTATIONS</h1>
            <p className="w-6/5 mt-5 md:w-4/5">
            ...
            <h1 className="text-3xl font-bold mt-5">REFUNDS POLICY</h1>
            <p className="w-6/5 md:w-4/5">
              All sales are final and no refund will be issued.
            </p>
            <h1 className="text-3xl font-bold mt-5">PROHIBITED ACTIVITIES</h1>
            <p className="w-6/5 md:w-4/5">
            ...
            <ul className=" mt-4 w-6/5 md:w-4/5">
              <li>
                <p>
            ...
            <p className=" mt-6 w-6/5 md:w-4/5">
            ...
            <h3 className="font-bold text-3xl mt-6">PRODUCTS OR SERVICES</h3>
            <p className="w-6/5 md:w-4/5">
              Data and images of products on the Site may be provided by
              third-party services. We have made every effort to display as
              accurately as possible the data and images of the products that
              appear on the Site. We cannot guarantee that your computer
              monitor's display of any data or images will be accurate or
              update-to-date. We reserve the right, but are not obligated, to
              ...
              of any products or services that we offer. We do not warrant that
            ...
            <h3 className="text-bold mt-6 text-3xl">THIRD-PARTY LINKS</h3>
            <p className="w-6/5 md:w-4/5">
            ...
            <h3 className="font-bold text-3xl mt-6">CONTRIBUTION LICENSE</h3>
            <p className="w-6/5 md:w-4/5">
            ...
            <h3 className="font-bold text-3xl mt-6">SITE MANAGEMENT</h3>
            <p className=" mt-3 w-6/5 md:w-4/5">
            ...
            <h3 className="font-bold mt-6 text-4xl">TERM AND TERMINATION</h3>
            <p className="w-6/5 mt-3 md:w-4/5 ">
              These Terms of Use shall remain in full force and effect while you
              use the Site. WITHOUT mt-3LIMITING ANY OTHER PROVISION OF THESE
            ...
            <p className="w-6/5 mt-3 md:w-3/5">
            ...
            <h3 className="font-bold text-3xl my-3">DISPUTE RESOLUTION</h3>
            <h4 className="font-bold text-2xl mt-4">Binding Arbitration</h4>
            <p className="w-6/5 mt-3 md:w-4/5">
            ...
            <h4 className="font-bold mt-6 text-2xl "> Restrictions </h4>
            <p className="w-6/5 md:w-3/5">
            ...
            <h4 className="text-bold text-3xl mt-46"> CORRECTIONS</h4>
            <p className="mt-3 w-6/5 md:w-3/5">
            ...
            <h4 className="text-bold text-3xl mt-6">DISCLAIMER</h4>
            <p className=" mt-3 w-6/5 md:w-3/5">
            ...
            <p className="w-6/5 md:w-3/5">
              ...
              ANY, BY YOU TO US. CERTAIN STATE LAWS DO NOT ALLOW LIMITATIONS ON
            ...
            <h4 className="font-bold text-3xl mt-6"> INDEMNIFICATION </h4>
            <p className="w-6/5 mt-3 md:w-4/5 ">
            ...
            <h4 className="font-bold text-3xl mt-6">USER DATA</h4>
            <p className=" mt-3 w-6/5  md:w-4/5">
            ...
            <h4 className="font-bold text-3xl mt-4">MISCELLANEOUS</h4>
            <p className=" mt-3 w-6/5 md:w-4/5">
            ...
            <h3 className="font-bold text-3xl mt-4">CONTACT US</h3>
            <p className=" mt-3 w-6/5 md:w-4/5">
              In order to resolve a complaint regarding the Site or to receive
              further information regarding use of the Site, please contact us
              at: <b>support@zyteon.com</b> .
            </p>
          </div>
        </div>
      </div>
