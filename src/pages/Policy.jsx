...
export const Policy = () => {
  return (
    <>
      <Header />
      <div className="container mx-auto px-5 font-body">
        <div className="flex justify-center">
          <div className="mt-10">
            <h2 className={style.title}>Privacy Policy</h2>

            <div className={style.box}>
              <h2 className={style.title}>AGREEMENT TO TERMS</h2>
              <p className={style.text}>
                These Terms of Use constitute a legally binding agreement made
                between you, whether personally or on behalf of an entity
                (“you”) and zyteon, ("Zyteon", “we”, “us”, or “our”), concerning
                your access to and use of the Zyteon website as well as any
                ...
                Use are posted. The information provided on the Site is not
            ...
            <div className={style.box}>
              <p className={style.text}>
                ...
                Unless otherwise indicated, the Site are our proprietary
            ...
            <div className={style.box}>
              <p className={style.text}>
                <h3 className={style.sub_title}>I USER REPRESENTATIONS</h3>
            ...
            <div className={style.box}>
              <h3 className={style.sub_title}>REFUNDS POLICY</h3>
            ...
            <div className={style.box}>
              ...
              <h3 className={style.sub_title}>USER GENERATED CONTRIBUTIONS</h3>
              <p className={style.text}>
              ...
              <div className={style.box}>
                <h3 className={style.sub_title}>PRODUCTS OR SERVICES</h3>
                <p className={style.text}>
                  Data and images of products on the Site may be provided by
                  third-party services. We have made every effort to display as
                  accurately as possible the data and images of the products
                  that appear on the Site. We cannot guarantee that your
                  computer monitor's display of any data or images will be
                  accurate or update-to-date. We reserve the right, but are not
                  ...
                  offer. We do not warrant that the quality of any products,
              ...
              <div className={style.box}>
                <h3 className={style.sub_title}>CONTRIBUTION LICENSE</h3>
                <p className={style.text}>
            ...
            <div className={style.box}>
              <h3 className={style.sub_title}>SITE MANAGEMENT</h3>
              <p className={style.text}>
            ...
            <div className={style.box}>
              <h3 className={style.sub_title}>TERM AND TERMINATION</h3>
              <p className={style.text}>
            ...
            <div className={style.box}>
              ...
              <p className={style.text}>
                ...
                Site. We cannot guarantee the Site will be available at all
            ...
            <div className={style.box}>
              <h3 className={style.sub_title}>DISPUTE RESOLUTION</h3>
            </div>
            <div className={style.box}>
              <h4 className={style.small_title}>Binding Arbitration</h4>
              <p className={style.text}>
            ...
            <div className={style.box}>
              <h4 className={style.small_title}> Restrictions </h4>
              <p className={style.text}>
            ...
            <div className={style.box}>
              <h4 className={style.small_title}> CORRECTIONS</h4>
              <p className={style.text}>
            ...
            <div className={style.box}>
              <h4 className={style.small_title}>DISCLAIMER</h4>
              <p className={style.text}>
            ...
            <div className={style.box}>
              <h4 className={style.small_title}>LIMITATIONS OF LIABILITY</h4>
              <p className={style.text}>
                ...
                PAID, IF ANY, BY YOU TO US. CERTAIN STATE LAWS DO NOT ALLOW
            ...
            <div className={style.box}>
              <h4 className={style.small_title}> INDEMNIFICATION </h4>
              <p className={style.text}>
            ...
            <div className={style.box}>
              <h4 className={style.small_title}>USER DATA</h4>
              <p className={style.text}>
            ...
            <div className={style.box}>
              <h4 className={style.small_title}>
            ...
            <div className={style.box}>
              <h4 className={style.small_title}>MISCELLANEOUS</h4>
              <p className={style.text}>
